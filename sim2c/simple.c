...
EXPORT void collect__simple(void) {
  ...
  func__69_32 = collect_node(func__69_32);
  string__69_37 = collect_node(string__69_37);
  string__69_44 = collect_node(string__69_44);
  string__69_45 = collect_node(string__69_45);
  ...
  string__73_3 = collect_node(string__73_3);
  string__73_7 = collect_node(string__73_7);
  string__73_11 = collect_node(string__73_11);
  string__73_14 = collect_node(string__73_14);
...
int main(int argc, char **argv) {
  ...
  assign_value(&func__69_32, create_function(entry__69_32, 0));
