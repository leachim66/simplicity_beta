...
static CONTINUATION_INFO continuation_info[] = {
  ...
  {entry__64_1, NULL, 317, 317, 22, 56},
  {cont__64_2, &frame__64_1, 317, 317, 3, 62},
  ...
  {entry__74_37, NULL, 668, 668, 24, 43},
  {cont__74_38, &frame__74_37, 668, 668, 51, 70},
  {cont__74_39, &frame__74_37, 668, 668, 15, 72},
  {cont__74_42, &frame__74_37, 667, 668, 13, 72},
  {entry__74_43, NULL, 669, 669, 16, 29},
  {cont__74_45, &frame__74_43, 669, 669, 13, 29},
  {entry__74_35, NULL, 665, 665, 13, 34},
  {cont__74_36, &frame__74_35, 664, 669, 11, 28},
  {cont__74_46, &frame__74_35, 663, 669, 9, 30},
  {entry__74_20, NULL, 657, 657, 9, 35},
  {cont__74_22, &frame__74_20, 656, 669, 7, 30},
  {cont__74_47, &frame__74_20, 654, 669, 5, 32},
  ...
  {cont__74_19, &frame__74_1, 653, 669, 3, 33},
...
static void entry__64_1(void) {
  ...
  // 317: ... std::key_value_pair(SORT std::true)
  argument_count = 2;
  arguments = node_p;
...
static void cont__64_2(void) {
  ...
  // 317: $entries directory(std::key_value_pair(SORT std::true) path)
  argument_count = 2;
  arguments = node_p;
...
static void cont__74_22(void) {
  ...
  // 666:     
  // 667:     -> # Linux only
  // 668:       "-l:lib@(library .before. '.').so.@(library .behind. '.')"
  // 669:     -> "-l@(library)"
