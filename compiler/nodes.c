...
EXPORT void phase_3__nodes(void) {
  ...
  var.compiler__namespace_instruction = create_future();
  ...
  var.compiler__define_static_multi = create_future();
  ...
  var.compiler__define_dynamic_single = create_future();
  ...
  var.compiler__define_dynamic_multi = create_future();
  ...
  var.compiler__attribute_function_pair = create_future();
  ...
  var.compiler__polymorphic_function_with_setter = create_future();
...
EXPORT void phase_5__nodes(void) {
  ...
  initialize_future(var.compiler__NONE, unique__compiler__NONE);
  initialize_future(var.compiler__ATTRIBUTE_KIND, unique__compiler__ATTRIBUTE_KIND);
  initialize_future(var.compiler__METHOD_KIND, unique__compiler__METHOD_KIND);
  initialize_future(var.compiler__NO_PARAMETER, unique__compiler__NO_PARAMETER);
  initialize_future(var.compiler__IN_PARAMETER, unique__compiler__IN_PARAMETER);
  initialize_future(var.compiler__IN_OUT_PARAMETER, unique__compiler__IN_OUT_PARAMETER);
  initialize_future(var.compiler__OUT_PARAMETER, unique__compiler__OUT_PARAMETER);
  initialize_future(var.compiler__MYSELF_PARAMETER, unique__compiler__MYSELF_PARAMETER);
  initialize_future(var.compiler__CONTINUATION_PARAMETER, unique__compiler__CONTINUATION_PARAMETER);
  initialize_future(var.compiler__LEFT, unique__compiler__LEFT);
  initialize_future(var.compiler__RIGHT, unique__compiler__RIGHT);
  initialize_future(var.compiler__POLYMORPHIC, unique__compiler__POLYMORPHIC);
  initialize_future(var.compiler__STATIC_SINGLE, unique__compiler__STATIC_SINGLE);
  initialize_future(var.compiler__STATIC_MULTI, unique__compiler__STATIC_MULTI);
  initialize_future(var.compiler__DYNAMIC_SINGLE, unique__compiler__DYNAMIC_SINGLE);
  initialize_future(var.compiler__DYNAMIC_MULTI, unique__compiler__DYNAMIC_MULTI);
  initialize_future(var.compiler__C_NODE, unique__compiler__C_NODE);
  ...
  initialize_future(var.compiler__meta_instruction, get__types__grammar_node());
  initialize_future(var.compiler__require_instruction, var.compiler__meta_instruction);
  initialize_future(var.compiler__namespace_instruction, var.compiler__meta_instruction);
  initialize_future(var.compiler__using_instruction, var.compiler__meta_instruction);
  initialize_future(var.compiler__include_instruction, var.compiler__meta_instruction);
  initialize_future(var.compiler__link_instruction, var.compiler__meta_instruction);
  initialize_future(var.compiler__data_instruction, var.compiler__meta_instruction);
  assign_value(&var.node__is_a_remark, create_function(type__node__is_a_remark, -1));
  initialize_future(var.compiler__remark_statement, var.compiler__statement);
  ...
  initialize_future(var.compiler__body, get__types__grammar_node());
  initialize_future(var.compiler__statement, get__types__grammar_node());
  assign_value(&var.node__is_a_call, create_function(type__node__is_a_call, -1));
  initialize_future(var.compiler__call, var.compiler__statement);
  assign_value(&var.node__is_a_procedure_call, create_function(type__node__is_a_procedure_call, -1));
  initialize_future(var.compiler__procedure_call, var.compiler__call);
  assign_value(&var.node__is_a_return, create_function(type__node__is_a_return, -1));
  initialize_future(var.compiler__return_statement, var.compiler__call);
  assign_value(&var.node__is_an_assignment, create_function(type__node__is_an_assignment, -1));
  initialize_future(var.compiler__assignment, var.compiler__call);
  ...
  initialize_future(var.compiler__polymorphic_function, get__types__grammar_node());
  initialize_future(var.compiler__polymorphic_function_with_setter, var.compiler__polymorphic_function);
  ...
  initialize_future(var.compiler__identifier, get__types__grammar_node());
  assign_value(&var.node__is_a_temporary, create_function(type__node__is_a_temporary, -1));
  initialize_future(var.compiler__temporary, var.compiler__identifier);
  assign_value(&var.node__is_an_operator_symbol, create_function(type__node__is_an_operator_symbol, -1));
  initialize_future(var.compiler__operator_symbol, var.compiler__identifier);
