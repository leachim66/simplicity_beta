...
static struct {
  NODE *compiler__cut_into_fragments;
} var;
...
static FRAME_INFO frame__compiler__cut_into_fragments_3 = {7, {"idx", "chr", "no", "buf", "fragments", "start_no", "start_idx"}};
static void cont__compiler__cut_into_fragments_4(void);
static NODE *func__compiler__cut_into_fragments_5;
static void entry__compiler__cut_into_fragments_5(void);
static FRAME_INFO frame__compiler__cut_into_fragments_5 = {6, {"no", "idx", "buf", "fragments", "start_no", "start_idx"}};
static void cont__compiler__cut_into_fragments_6(void);
static void cont__compiler__cut_into_fragments_7(void);
static void cont__compiler__cut_into_fragments_8(void);
static NODE *func__compiler__cut_into_fragments_9;
static void entry__compiler__cut_into_fragments_9(void);
static FRAME_INFO frame__compiler__cut_into_fragments_9 = {2, {"buf", "idx"}};
static void cont__compiler__cut_into_fragments_10(void);
static void cont__compiler__cut_into_fragments_11(void);
static void cont__compiler__cut_into_fragments_12(void);
static NODE *func__compiler__cut_into_fragments_13;
static void entry__compiler__cut_into_fragments_13(void);
static FRAME_INFO frame__compiler__cut_into_fragments_13 = {2, {"buf", "idx"}};
static void cont__compiler__cut_into_fragments_14(void);
static void cont__compiler__cut_into_fragments_15(void);
static void cont__compiler__cut_into_fragments_16(void);
static void cont__compiler__cut_into_fragments_17(void);
static void cont__compiler__cut_into_fragments_18(void);
static void cont__compiler__cut_into_fragments_19(void);
static NODE *func__compiler__cut_into_fragments_20;
static void entry__compiler__cut_into_fragments_20(void);
static FRAME_INFO frame__compiler__cut_into_fragments_20 = {6, {"fragments", "start_no", "buf", "start_idx", "idx", "no"}};
static void cont__compiler__cut_into_fragments_21(void);
static void cont__compiler__cut_into_fragments_22(void);
static void cont__compiler__cut_into_fragments_23(void);
static void cont__compiler__cut_into_fragments_24(void);
static NODE *get__compiler__cut_into_fragments(void) {
  return var.compiler__cut_into_fragments;
}
void run__fragments(void);

static CONTINUATION_INFO continuation_info[] = {
  {run__fragments, NULL, },
  {entry__compiler__cut_into_fragments_13, NULL, 39, 39, 59, 63},
  {cont__compiler__cut_into_fragments_14, &frame__compiler__cut_into_fragments_13, 39, 39, 55, 64},
  {cont__compiler__cut_into_fragments_15, &frame__compiler__cut_into_fragments_13, 39, 39, 55, 71},
  {cont__compiler__cut_into_fragments_16, &frame__compiler__cut_into_fragments_13, 39, 39, 55, 71},
  {cont__compiler__cut_into_fragments_17, &frame__compiler__cut_into_fragments_13, 39, 39, 55, 71},
  {entry__compiler__cut_into_fragments_9, NULL, 39, 39, 39, 43},
  {cont__compiler__cut_into_fragments_10, &frame__compiler__cut_into_fragments_9, 39, 39, 35, 44},
  {cont__compiler__cut_into_fragments_11, &frame__compiler__cut_into_fragments_9, 39, 39, 35, 50},
  {cont__compiler__cut_into_fragments_12, &frame__compiler__cut_into_fragments_9, 39, 39, 35, 71},
  {cont__compiler__cut_into_fragments_18, &frame__compiler__cut_into_fragments_9, 39, 39, 35, 71},
  {entry__compiler__cut_into_fragments_20, NULL, 45, 45, 32, 55},
  {cont__compiler__cut_into_fragments_21, &frame__compiler__cut_into_fragments_20, 40, 45, 9, 56},
  {cont__compiler__cut_into_fragments_22, &frame__compiler__cut_into_fragments_20, 47, 47, 9, 24},
  {cont__compiler__cut_into_fragments_23, &frame__compiler__cut_into_fragments_20, 47, 47, 24, 24},
  {entry__compiler__cut_into_fragments_5, NULL, 38, 38, 7, 13},
  {cont__compiler__cut_into_fragments_6, &frame__compiler__cut_into_fragments_5, 39, 39, 17, 30},
  {cont__compiler__cut_into_fragments_7, &frame__compiler__cut_into_fragments_5, 39, 39, 10, 30},
  {cont__compiler__cut_into_fragments_8, &frame__compiler__cut_into_fragments_5, 39, 39, 10, 71},
...
static void entry__compiler__cut_into_fragments_1(void) {
  ...
  myself = get__list();
  func = myself->type;
  frame->cont = cont__compiler__cut_into_fragments_2;
}
static void cont__compiler__cut_into_fragments_2(void) {
  if (argument_count != 1) {
  ...
  // ...
  frame->slots[5] /* temp__1 */ = create_closure(entry__compiler__cut_into_fragments_3, 2);
  ...
  func = myself->type;
  frame->cont = cont__compiler__cut_into_fragments_24;
}
static void entry__compiler__cut_into_fragments_20(void) {
  ...
  myself = get__range();
  func = myself->type;
  frame->cont = cont__compiler__cut_into_fragments_21;
}
static void cont__compiler__cut_into_fragments_21(void) {
  if (argument_count != 1) {
    invalid_results_error();
  ...
  // 45:   .compiler::text_of range(buf start_idx idx)
  {
    ...
    set_attribute_value(temp->attributes, poly_idx__compiler__text_of, frame->slots[7] /* temp__2 */);
  ...
  myself = get__push();
  func = myself->type;
  frame->cont = cont__compiler__cut_into_fragments_22;
}
static void cont__compiler__cut_into_fragments_22(void) {
  if (argument_count != 1) {
    invalid_results_error();
  ...
  func = myself->type;
  frame->cont = cont__compiler__cut_into_fragments_23;
}
static void cont__compiler__cut_into_fragments_23(void) {
  if (argument_count != 1) {
    invalid_results_error();
...
static void entry__compiler__cut_into_fragments_5(void) {
  ...
  myself = get__inc();
  func = myself->type;
  frame->cont = cont__compiler__cut_into_fragments_6;
}
static void cont__compiler__cut_into_fragments_6(void) {
  if (argument_count != 1) {
    invalid_results_error();
  ...
  func = myself->type;
  frame->cont = cont__compiler__cut_into_fragments_7;
}
static void cont__compiler__cut_into_fragments_7(void) {
  if (argument_count != 1) {
    invalid_results_error();
  ...
  func = myself->type;
  frame->cont = cont__compiler__cut_into_fragments_8;
}
static void cont__compiler__cut_into_fragments_8(void) {
  if (argument_count != 1) {
    invalid_results_error();
  ...
  frame->slots[9] /* temp__4 */ = create_closure(entry__compiler__cut_into_fragments_9, 0);
  ...
  myself = get__std__or();
  func = myself->type;
  frame->cont = cont__compiler__cut_into_fragments_19;
}
static void entry__compiler__cut_into_fragments_9(void) {
  ...
  myself = get__std__plus();
  func = myself->type;
  frame->cont = cont__compiler__cut_into_fragments_10;
}
static void cont__compiler__cut_into_fragments_10(void) {
  if (argument_count != 1) {
    invalid_results_error();
  ...
  func = myself->type;
  frame->cont = cont__compiler__cut_into_fragments_11;
}
static void cont__compiler__cut_into_fragments_11(void) {
  if (argument_count != 1) {
    invalid_results_error();
  ...
  func = myself->type;
  frame->cont = cont__compiler__cut_into_fragments_12;
}
static void cont__compiler__cut_into_fragments_12(void) {
  if (argument_count != 1) {
    invalid_results_error();
  ...
  // 39: ... buf(idx+1) != '}'
  frame->slots[6] /* temp__5 */ = create_closure(entry__compiler__cut_into_fragments_13, 0);
  // 39: ... buf(idx+1) > ' ' && buf(idx+1) != '}'
  argument_count = 2;
  arguments = node_p;
  ...
  func = myself->type;
  frame->cont = cont__compiler__cut_into_fragments_18;
}
static void entry__compiler__cut_into_fragments_13(void) {
  ...
  myself = get__std__plus();
  func = myself->type;
  frame->cont = cont__compiler__cut_into_fragments_14;
}
static void cont__compiler__cut_into_fragments_14(void) {
  if (argument_count != 1) {
    invalid_results_error();
  ...
  myself = frame->slots[0] /* buf */;
  func = myself->type;
  frame->cont = cont__compiler__cut_into_fragments_15;
}
static void cont__compiler__cut_into_fragments_15(void) {
  if (argument_count != 1) {
    invalid_results_error();
  ...
  myself = get__std__equal();
  func = myself->type;
  frame->cont = cont__compiler__cut_into_fragments_16;
}
static void cont__compiler__cut_into_fragments_16(void) {
  if (argument_count != 1) {
    invalid_results_error();
  ...
  func = myself->type;
  frame->cont = cont__compiler__cut_into_fragments_17;
}
static void cont__compiler__cut_into_fragments_17(void) {
  if (argument_count != 1) {
    invalid_results_error();
...
static void cont__compiler__cut_into_fragments_19(void) {
  ...
  // 46:   !start_no no
  // 47:   !start_idx idx+1
  frame->slots[10] /* temp__5 */ = create_closure(entry__compiler__cut_into_fragments_20, 0);
  // 39: if idx == length_of(buf) || buf(idx+1) > ' ' && buf(idx+1) != '}':
  // 40:   push
  // 41:     &fragments
  // 42:     types::object
...
static void entry__compiler__cut_into_fragments_3(void) {
  ...
  myself = get__std__equal();
  func = myself->type;
  frame->cont = cont__compiler__cut_into_fragments_4;
}
static void cont__compiler__cut_into_fragments_4(void) {
  if (argument_count != 1) {
    invalid_results_error();
  ...
  // 46:     !start_no no
  // ...
  frame->slots[8] /* temp__2 */ = create_closure(entry__compiler__cut_into_fragments_5, 0);
  // 37: if chr == '@nl;':
  // 38:   inc &no
  // 39:   if idx == length_of(buf) || buf(idx+1) > ' ' && buf(idx+1) != '}':
  // 40:     push
...
EXPORT void collect__fragments(void) {
  var.compiler__cut_into_fragments = collect_node(var.compiler__cut_into_fragments);
}
...
EXPORT void phase_4__fragments(void) {
  ...
  set_module("fragments");
  set_used_namespaces(used_namespaces);
  use_polymorphic_function("compiler", "text_of", &get__compiler__text_of, &poly_idx__compiler__text_of);
