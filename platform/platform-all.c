...
static NODE *get__std__platform(void) {
  return var.std__platform;
}
...
static MODULE_INFO module_info = {
  ...
  used_namespaces,
  {DEBUG_FILENAME("platform/platform-all.sim")}
};
...
static void cont__4_2(void) {
  ...
  initialize_future(var.std__platforms, arguments->slots[0]);
