...
static CONTINUATION_INFO continuation_info[] = {
  {run__platform__platform, NULL, 24, 24, 1, 51},
  {cont__6_4, NULL, }
};
...
static MODULE_INFO module_info = {
  ...
  used_namespaces,
  {DEBUG_FILENAME("platform/platform-linux.sim"), DEBUG_FILENAME("platform/platform-posix-common.sim")}
};
...
EXPORT void run__platform__platform(void) {
  ...
  // 24: $std::current_platforms list("linux" "posix" "all")
  argument_count = 3;
  arguments = node_p;
