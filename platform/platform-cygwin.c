...
static CONTINUATION_INFO continuation_info[] = {
  {run__platform__platform, NULL, 24, 24, 1, 52},
  {cont__6_4, NULL, }
};
...
static MODULE_INFO module_info = {
  ...
  used_namespaces,
  {DEBUG_FILENAME("platform/platform-cygwin.sim"), DEBUG_FILENAME("platform/platform-posix-common.sim")}
};
...
EXPORT void run__platform__platform(void) {
  ...
  // 24: $std::current_platforms list("cygwin" "posix" "all")
  argument_count = 3;
  arguments = node_p;
...
EXPORT void phase_2__platform__platform(void) {
  ...
  string__1_1 = from_latin_1_string("cygwin", 6);
  string__6_1 = from_latin_1_string("cygwin", 6);
