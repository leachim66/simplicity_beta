...
static CONTINUATION_INFO continuation_info[] = {
  {run__platform__platform, NULL, 24, 24, 1, 41},
  {cont__6_3, NULL, }
};
...
static MODULE_INFO module_info = {
  ...
  used_namespaces,
  {DEBUG_FILENAME("platform/platform-win.sim"), DEBUG_FILENAME("platform/platform-win-common.sim")}
};
...
EXPORT void run__platform__platform(void) {
  ...
  // 24: $std::current_platforms list("win" "all")
  argument_count = 2;
  arguments = node_p;
...
EXPORT void phase_5__platform__platform(void) {
  ...
  assign_value(&var.std__current_directory_separator, character__92);
  assign_value(&var.std__current_path_separator, character__59);
}
