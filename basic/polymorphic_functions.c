...
static CONTINUATION_INFO continuation_info[] = {
  ...
  {type__std__minus, NULL, 31, 31, 2, 11},
  {type__std__times, NULL, 39, 39, 2, 11},
  {type__std__over, NULL, 47, 47, 2, 10},
  {type__std__div, NULL, 55, 55, 2, 9},
  ...
  {type__std__push, NULL, 497, 497, 2, 10},
  {type__std__pop, NULL, 505, 505, 2, 9},
  {type__std__peek, NULL, 513, 513, 2, 10},
  {type__std__drop, NULL, 521, 521, 2, 10},
  {type__std__put, NULL, 529, 529, 2, 9},
  {type__std__get, NULL, 537, 537, 2, 9},
  {type__std__next, NULL, 545, 545, 2, 10},
  {type__std__append, NULL, 551, 551, 2, 12},
  {type__std__insert_before, NULL, 559, 559, 2, 19},
  {type__std__insert_behind, NULL, 572, 572, 2, 19},
  {type__std__first_index_of, NULL, 585, 585, 2, 20},
  {type__std__last_index_of, NULL, 592, 592, 2, 19},
  {type__std__delete_at, NULL, 599, 599, 2, 15},
  {type__std__union, NULL, 608, 608, 2, 11},
  {type__std__intersection, NULL, 614, 614, 2, 18},
  {type__std__match_character, NULL, 620, 620, 2, 21},
  {type__std__match_string, NULL, 628, 628, 2, 18},
  {type__std__search_character, NULL, 636, 636, 2, 22},
  {type__std__search_string, NULL, 644, 644, 2, 19},
  {type__std__match, NULL, 652, 652, 2, 11},
  {type__std__search, NULL, 661, 661, 2, 12},
  {type__std__matches, NULL, 669, 669, 2, 13},
  {type__std__contains, NULL, 677, 677, 2, 14},
  {type__std__has_prefix, NULL, 685, 685, 2, 16},
  {type__std__has_suffix, NULL, 691, 691, 2, 16},
  {type__std__without_prefix, NULL, 699, 699, 2, 20},
  {type__std__without_suffix, NULL, 714, 714, 2, 20},
  {type__std__before, NULL, 729, 729, 2, 12},
  {type__std__truncate_from, NULL, 748, 748, 2, 19},
  {type__std__behind, NULL, 768, 768, 2, 12},
  {type__std__truncate_until, NULL, 787, 787, 2, 20},
  {type__std__from, NULL, 807, 807, 2, 10},
  {type__std__truncate_before, NULL, 826, 826, 2, 21},
  {type__std__until, NULL, 846, 846, 2, 11},
  {type__std__truncate_behind, NULL, 865, 865, 2, 21},
  {type__std__between, NULL, 885, 885, 2, 13},
  {type__std__range, NULL, 906, 906, 2, 11},
  {type__std__merge, NULL, 933, 933, 2, 11},
  {type__std__sort, NULL, 939, 939, 2, 10},
  {type__std__close, NULL, 945, 945, 2, 11},
  {type__std__write_some_bytes_to, NULL, 951, 951, 2, 25},
  {type__std__write_to, NULL, 959, 959, 2, 14},
  {type__std__flush, NULL, 965, 965, 2, 11},
  {type__std__read_some_bytes_from, NULL, 969, 969, 2, 26},
  {type__std__read_from, NULL, 977, 977, 2, 15},
  {type__std__key_of, NULL, 983, 983, 2, 12},
  {type__std__value_of, NULL, 989, 989, 2, 14},
  {type__std__keys_of, NULL, 995, 995, 2, 13},
  {type__std__values_of, NULL, 1001, 1001, 2, 15},
  {type__std__lower_bound_of, NULL, 1007, 1007, 2, 20},
  {type__std__upper_bound_of, NULL, 1013, 1013, 2, 20},
  {type__std__for_each_from_to, NULL, 1019, 1019, 2, 22},
  {type__std__for_each_from_down_to, NULL, 1026, 1026, 2, 27},
  {type__std__for_each, NULL, 1033, 1033, 2, 14},
  {type__std__for_each_downwards, NULL, 1040, 1040, 2, 24},
  {type__std__update_each_from_to, NULL, 1047, 1047, 2, 25},
  {type__std__update_each_from_down_to, NULL, 1054, 1054, 2, 30},
  {type__std__update_each, NULL, 1061, 1061, 2, 17},
  {type__std__update_each_downwards, NULL, 1068, 1068, 2, 27},
  {type__std__for_each_pair, NULL, 1075, 1075, 2, 19},
  {type__std__new_empty_collection, NULL, 1083, 1083, 2, 26},
  {type__std__filter, NULL, 1089, 1089, 2, 12},
  {type__std__apply, NULL, 1095, 1095, 2, 11},
  {type__std__map, NULL, 1103, 1103, 2, 9},
  {type__std__dup, NULL, 1111, 1111, 2, 9},
  {type__std__interleave, NULL, 1117, 1117, 2, 16},
  {type__std__stop, NULL, 1121, 1121, 2, 10},
  {type__std__get_file_descriptors, NULL, 1125, 1125, 2, 26},
  {type__std__handle_requests, NULL, 1132, 1132, 2, 21},
  {type__std__select, NULL, 1139, 1139, 2, 12},
  {type__std__delete, NULL, 1145, 1145, 2, 12},
  {type__std__update, NULL, 1151, 1151, 2, 12},
  {type__std__call_command, NULL, 1157, 1157, 2, 18},
