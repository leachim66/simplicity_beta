...
static CONTINUATION_INFO continuation_info[] = {
  ...
  {type__std__and, NULL, 38, 38, 2, 9},
  {type__std__or, NULL, 49, 49, 2, 8},
  {type__std__if, NULL, 60, 60, 2, 8},
  {type__std__unless, NULL, 80, 80, 2, 12},
  {type__std__shift_left, NULL, 97, 97, 2, 16},
  {type__std__shift_right, NULL, 109, 109, 2, 17},
  {type__std__bit_and, NULL, 123, 123, 2, 13},
  {type__std__bit_or, NULL, 132, 132, 2, 12},
  {type__std__bit_xor, NULL, 141, 141, 2, 13},
  {type__std__parameter_count_of, NULL, 150, 150, 2, 24},
  {type__std__is_defined, NULL, 162, 162, 2, 16},
  {type__std__is_undefined, NULL, 166, 166, 2, 18},
  {type__std__default_value, NULL, 170, 170, 2, 19},
  {type__std__is_valid, NULL, 171, 171, 2, 14},
  {type__std__to_string, NULL, 172, 172, 2, 15},
  {type__std__to_list, NULL, 173, 173, 2, 13},
  {type__std__serialize, NULL, 174, 174, 2, 15},
  {type__std__serialization_tag_of, NULL, 175, 175, 2, 26},
  {type__std__to_number, NULL, 176, 176, 2, 15},
  {type__std__parse_number, NULL, 177, 177, 2, 18},
  {type__std__to_integer, NULL, 178, 178, 2, 16},
  {type__std__parse_integer, NULL, 179, 179, 2, 19},
  {type__std__to_real, NULL, 180, 180, 2, 13},
  {type__std__parse_real, NULL, 181, 181, 2, 16},
  {type__std__to_lower_case, NULL, 182, 182, 2, 19},
  {type__std__to_upper_case, NULL, 183, 183, 2, 19},
  {type__std__to_title_case, NULL, 184, 184, 2, 19},
  {type__std__is_empty, NULL, 185, 185, 2, 14},
  {type__std__length_of, NULL, 186, 186, 2, 15},
  {type__std__type_of, NULL, 187, 187, 2, 13},
  {type__std__hash, NULL, 188, 188, 2, 10},
  {type__std__push, NULL, 189, 189, 2, 10},
  {type__std__pop, NULL, 190, 190, 2, 9},
  {type__std__peek, NULL, 191, 191, 2, 10},
  {type__std__drop, NULL, 192, 192, 2, 10},
  {type__std__put, NULL, 193, 193, 2, 9},
  {type__std__get, NULL, 194, 194, 2, 9},
  {type__std__next, NULL, 195, 195, 2, 10},
  {type__std__append, NULL, 196, 196, 2, 12},
  {type__std__insert_before, NULL, 197, 197, 2, 19},
  {type__std__insert_behind, NULL, 198, 198, 2, 19},
  {type__std__first_index_of, NULL, 199, 199, 2, 20},
  {type__std__last_index_of, NULL, 200, 200, 2, 19},
  {type__std__delete_at, NULL, 201, 201, 2, 15},
  {type__std__union, NULL, 202, 202, 2, 11},
  {type__std__intersection, NULL, 203, 203, 2, 18},
  {type__std__match_character, NULL, 204, 204, 2, 21},
  {type__std__match_string, NULL, 205, 205, 2, 18},
  {type__std__search_character, NULL, 206, 206, 2, 22},
  {type__std__search_string, NULL, 207, 207, 2, 19},
  {type__std__match, NULL, 208, 208, 2, 11},
  {type__std__search, NULL, 209, 209, 2, 12},
  {type__std__matches, NULL, 210, 210, 2, 13},
  {type__std__contains, NULL, 211, 211, 2, 14},
  {type__std__has_prefix, NULL, 212, 212, 2, 16},
  {type__std__has_suffix, NULL, 213, 213, 2, 16},
  {type__std__without_prefix, NULL, 214, 214, 2, 20},
  {type__std__without_suffix, NULL, 215, 215, 2, 20},
  {type__std__before, NULL, 216, 216, 2, 12},
  {type__std__truncate_from, NULL, 217, 217, 2, 19},
  {type__std__behind, NULL, 218, 218, 2, 12},
  {type__std__truncate_until, NULL, 219, 219, 2, 20},
  {type__std__from, NULL, 220, 220, 2, 10},
  {type__std__truncate_before, NULL, 221, 221, 2, 21},
  {type__std__until, NULL, 222, 222, 2, 11},
  {type__std__truncate_behind, NULL, 223, 223, 2, 21},
  {type__std__between, NULL, 224, 224, 2, 13},
  {type__std__range, NULL, 225, 225, 2, 11},
  {type__std__merge, NULL, 226, 226, 2, 11},
  {type__std__sort, NULL, 227, 227, 2, 10},
  {type__std__close, NULL, 228, 228, 2, 11},
  {type__std__write_some_bytes_to, NULL, 229, 229, 2, 25},
  {type__std__write_to, NULL, 230, 230, 2, 14},
  {type__std__flush, NULL, 231, 231, 2, 11},
  {type__std__read_some_bytes_from, NULL, 232, 232, 2, 26},
  {type__std__read_from, NULL, 233, 233, 2, 15},
  {type__std__key_of, NULL, 234, 234, 2, 12},
  {type__std__value_of, NULL, 235, 235, 2, 14},
  {type__std__keys_of, NULL, 236, 236, 2, 13},
  {type__std__values_of, NULL, 237, 237, 2, 15},
  {type__std__lower_bound_of, NULL, 238, 238, 2, 20},
  {type__std__upper_bound_of, NULL, 239, 239, 2, 20},
  {type__std__for_each_from_to, NULL, 240, 240, 2, 22},
  {type__std__for_each_from_down_to, NULL, 241, 241, 2, 27},
  {type__std__for_each, NULL, 242, 242, 2, 14},
  {type__std__for_each_downwards, NULL, 243, 243, 2, 24},
  {type__std__update_each_from_to, NULL, 244, 244, 2, 25},
  {type__std__update_each_from_down_to, NULL, 245, 245, 2, 30},
  {type__std__update_each, NULL, 246, 246, 2, 17},
  {type__std__update_each_downwards, NULL, 247, 247, 2, 27},
  {type__std__for_each_pair, NULL, 248, 248, 2, 19},
  {type__std__new_empty_collection, NULL, 249, 249, 2, 26},
  {type__std__filter, NULL, 250, 250, 2, 12},
  {type__std__apply, NULL, 251, 251, 2, 11},
  {type__std__map, NULL, 252, 252, 2, 9},
  {type__std__dup, NULL, 253, 253, 2, 9},
  {type__std__interleave, NULL, 254, 254, 2, 16},
  {type__std__stop, NULL, 255, 255, 2, 10},
  {type__std__get_file_descriptors, NULL, 256, 256, 2, 26},
  {type__std__handle_requests, NULL, 257, 257, 2, 21},
  {type__std__select, NULL, 258, 258, 2, 12},
  {type__std__delete, NULL, 259, 259, 2, 12},
  {type__std__update, NULL, 260, 260, 2, 12},
  {type__std__call_command, NULL, 261, 261, 2, 18},
