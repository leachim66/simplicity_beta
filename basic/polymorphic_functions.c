...
static CONTINUATION_INFO continuation_info[] = {
  ...
  {type__std__write_some_bytes_to, NULL, 952, 952, 2, 25},
  {type__std__write_to, NULL, 960, 960, 2, 14},
  {type__std__flush, NULL, 966, 966, 2, 11},
  {type__std__read_some_bytes_from, NULL, 970, 970, 2, 26},
  {type__std__read_from, NULL, 978, 978, 2, 15},
  {type__std__key_of, NULL, 984, 984, 2, 12},
  {type__std__value_of, NULL, 990, 990, 2, 14},
  {type__std__keys_of, NULL, 996, 996, 2, 13},
  {type__std__values_of, NULL, 1002, 1002, 2, 15},
  {type__std__lower_bound_of, NULL, 1008, 1008, 2, 20},
  {type__std__upper_bound_of, NULL, 1014, 1014, 2, 20},
  {type__std__for_each_from_to, NULL, 1020, 1020, 2, 22},
  {type__std__for_each_from_down_to, NULL, 1027, 1027, 2, 27},
  {type__std__for_each, NULL, 1034, 1034, 2, 14},
  {type__std__for_each_downwards, NULL, 1041, 1041, 2, 24},
  {type__std__update_each_from_to, NULL, 1048, 1048, 2, 25},
  {type__std__update_each_from_down_to, NULL, 1055, 1055, 2, 30},
  {type__std__update_each, NULL, 1062, 1062, 2, 17},
  {type__std__update_each_downwards, NULL, 1069, 1069, 2, 27},
  {type__std__for_each_pair, NULL, 1076, 1076, 2, 19},
  {type__std__new_empty_collection, NULL, 1084, 1084, 2, 26},
  {type__std__filter, NULL, 1090, 1090, 2, 12},
  {type__std__apply, NULL, 1096, 1096, 2, 11},
  {type__std__map, NULL, 1104, 1104, 2, 9},
  {type__std__dup, NULL, 1112, 1112, 2, 9},
  {type__std__interleave, NULL, 1118, 1118, 2, 16},
  {type__std__stop, NULL, 1122, 1122, 2, 10},
  {type__std__get_file_descriptors, NULL, 1126, 1126, 2, 26},
  {type__std__handle_requests, NULL, 1133, 1133, 2, 21},
  {type__std__select, NULL, 1140, 1140, 2, 12},
  {type__std__delete, NULL, 1146, 1146, 2, 12},
  {type__std__update, NULL, 1152, 1152, 2, 12},
  {type__std__call_command, NULL, 1158, 1158, 2, 18},
