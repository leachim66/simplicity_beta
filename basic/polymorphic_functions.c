...
static CONTINUATION_INFO continuation_info[] = {
  ...
  {type__std__sort, NULL, 934, 934, 2, 10},
  {type__std__close, NULL, 935, 935, 2, 11},
  {type__std__write_some_bytes_to, NULL, 936, 936, 2, 25},
  {type__std__write_to, NULL, 937, 937, 2, 14},
  {type__std__flush, NULL, 938, 938, 2, 11},
  {type__std__read_some_bytes_from, NULL, 939, 939, 2, 26},
  {type__std__read_from, NULL, 940, 940, 2, 15},
  {type__std__key_of, NULL, 941, 941, 2, 12},
  {type__std__value_of, NULL, 942, 942, 2, 14},
  {type__std__keys_of, NULL, 943, 943, 2, 13},
  {type__std__values_of, NULL, 944, 944, 2, 15},
  {type__std__lower_bound_of, NULL, 945, 945, 2, 20},
  {type__std__upper_bound_of, NULL, 946, 946, 2, 20},
  {type__std__for_each_from_to, NULL, 947, 947, 2, 22},
  {type__std__for_each_from_down_to, NULL, 948, 948, 2, 27},
  {type__std__for_each, NULL, 949, 949, 2, 14},
  {type__std__for_each_downwards, NULL, 950, 950, 2, 24},
  {type__std__update_each_from_to, NULL, 951, 951, 2, 25},
  {type__std__update_each_from_down_to, NULL, 952, 952, 2, 30},
  {type__std__update_each, NULL, 953, 953, 2, 17},
  {type__std__update_each_downwards, NULL, 954, 954, 2, 27},
  {type__std__for_each_pair, NULL, 955, 955, 2, 19},
  {type__std__new_empty_collection, NULL, 956, 956, 2, 26},
  {type__std__filter, NULL, 957, 957, 2, 12},
  {type__std__apply, NULL, 958, 958, 2, 11},
  {type__std__map, NULL, 959, 959, 2, 9},
  {type__std__dup, NULL, 960, 960, 2, 9},
  {type__std__interleave, NULL, 961, 961, 2, 16},
  {type__std__stop, NULL, 962, 962, 2, 10},
  {type__std__get_file_descriptors, NULL, 963, 963, 2, 26},
  {type__std__handle_requests, NULL, 964, 964, 2, 21},
  {type__std__select, NULL, 965, 965, 2, 12},
  {type__std__delete, NULL, 966, 966, 2, 12},
  {type__std__update, NULL, 967, 967, 2, 12},
  {type__std__call_command, NULL, 968, 968, 2, 18},
