...
static int poly_idx__is_a_function;
...
static struct {
  NODE *std__is_a_function;
  NODE *types__function;
} var;
static const char *var_names[] = {
};
static int poly_idx__std__is_a_function;
static void type__std__is_a_function(void);
static NODE *get__std__is_a_function(void) {
  return var.std__is_a_function;
}
static NODE *get__types__function(void) {
  return var.types__function;
}
static NODE *create__types__function();

static long func__types__function___debug_string(NODE *node, int indent, int max_depth, char *buf);
void run__basic__types__function(void);

static CONTINUATION_INFO continuation_info[] = {
  {type__std__is_a_function, NULL, 23, 23, 2, 19},
  {run__basic__types__function, NULL, }
};
...
static void type__std__is_a_function(void) {
  myself = get_attribute(arguments->slots[0], poly_idx__std__is_a_function);
  if (CONTAINS_AN_ATTRIBUTE_VALUE(myself)) {
    if (argument_count != 1) {
      ...
      set_attribute_value(temp->attributes, poly_idx__std__is_a_function, attr);
      arguments = node_p;
      argument_count = 1;
...
static MODULE_INFO module_info = {
  ...
  used_namespaces,
  {DEBUG_FILENAME("basic/types/function.sim")}
};
...
EXPORT void run__basic__types__function(void) {
  if (already_run) {
    func = frame->cont;
    frame->cont = invalid_continuation;
    return;
...
static ATTRIBUTES attributes__types__function = {
...
static void type__types__function(void) {
  {
    runtime_error("Attempt to call the function prototype object!");
  }
}
SIMPLE_NODE types__function__node =
  {
    type__types__function,
    &attributes__types__function
  };

static NODE *create__types__function() {
  return (NODE *)&types__function__node;
}

static long func__types__function___debug_string(NODE *node, int indent, int max_depth, char *buf) {
  return debug_print(indent, buf, "<function>");
}
EXPORT void collect__basic__types__function(void) {
  var.std__is_a_function = collect_node(var.std__is_a_function);
  var.types__function = collect_node(var.types__function);
  collect_static_attributes(&attributes__types__function);
}

static int already_run_phase_1 = false;

EXPORT void phase_1__basic__types__function(void) {
  if (already_run_phase_1) return;
  already_run_phase_1 = true;
  register_module_info(&module_info);
  define_polymorphic_function("std", "is_a_function", get__std__is_a_function, &poly_idx__std__is_a_function, &var.std__is_a_function);
}
...
EXPORT void phase_3__basic__types__function(void) {
  ...
  use_polymorphic_function(NULL, "is_a_function", &get__is_a_function, &poly_idx__is_a_function);
  use_read_only(NULL, "true", &get__true, &get_value_or_future__true);
  use_read_only("types", "object", &get__types__object, &get_value_or_future__types__object);
  define_attribute("types", "object", poly_idx__is_a_function, get__false());
