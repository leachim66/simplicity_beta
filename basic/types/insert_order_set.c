...
static CONTINUATION_INFO continuation_info[] = {
  ...
  {run__basic__types__insert_order_set, NULL, 35, 35, 1, 43},
  {entry__10_4, NULL, 47, 47, 8, 21},
  {cont__10_5, &frame__10_4, 47, 47, 5, 21},
  {entry__10_8, NULL, 50, 50, 15, 28},
  {cont__10_9, &frame__10_8, 50, 50, 9, 32},
  {cont__10_10, &frame__10_8, 51, 51, 47, 61},
  {cont__10_11, &frame__10_8, 51, 51, 9, 62},
  {cont__10_12, &frame__10_8, 51, 51, 10, 30},
  {cont__10_13, &frame__10_8, 51, 51, 9, 35},
  {cont__10_14, &frame__10_8, 51, 51, 62, 62},
  {entry__10_6, NULL, 49, 49, 14, 27},
  {cont__10_7, &frame__10_6, 49, 51, 7, 62},
  {cont__10_15, &frame__10_6, 52, 52, 7, 15},
  {entry__10_18, NULL, 55, 55, 20, 33},
  {cont__10_19, &frame__10_18, 55, 55, 9, 37},
  {cont__10_20, &frame__10_18, 56, 56, 10, 30},
  {cont__10_21, &frame__10_18, 56, 56, 9, 35},
  {cont__10_22, &frame__10_18, 56, 56, 45, 45},
  {entry__10_16, NULL, 54, 54, 10, 23},
...
EXPORT void run__basic__types__insert_order_set(void) {
  ...
  // 35: $types::insert_order_set types::generic_set
...
static void cont__10_7(void) {
  ...
  // 49: ... :
  // 50:   push &myself.keys_of key
  // 51:   !myself.index_table_of(key) length_of(keys_of(myself))
  frame->slots[4] /* temp__2 */ = create_closure(entry__10_8, 0);
  // 49: unless idx.is_defined:
  // 50:   push &myself.keys_of key
  // 51:   !myself.index_table_of(key) length_of(keys_of(myself))
  argument_count = 2;
  arguments = node_p;
...
static void cont__10_17(void) {
  ...
  frame->slots[3] /* temp__1 */ = arguments->slots[0];
  // 54: ... :
  // 55:   delete_at &myself.keys_of idx
  // 56:   !myself.index_table_of(key) undefined
  frame->slots[4] /* temp__2 */ = create_closure(entry__10_18, 0);
  // 54: if idx.is_defined:
  // 55:   delete_at &myself.keys_of idx
  // 56:   !myself.index_table_of(key) undefined
  argument_count = 2;
  arguments = node_p;
...
static void entry__10_24(void) {
  ...
  // 59: Error "Attempt to set a set element to a nonboolean value!"
  argument_count = 1;
  arguments = node_p;
...
static void cont__10_2(void) {
  ...
  // 43: $idx index_table_of(myself)(key)
  argument_count = 1;
  arguments = node_p;
...
static void cont__13_2(void) {
  ...
  // 66: if self.is_empty (-> undefined) -> keys_of(self)(1)
  argument_count = 3;
  arguments = node_p;
  arguments->slots[0] = frame->slots[1] /* temp__1 */;
...
static void cont__14_2(void) {
  ...
  // 69: if self.is_empty (-> undefined) -> keys_of(self)(-1)
  argument_count = 3;
  arguments = node_p;
  arguments->slots[0] = frame->slots[1] /* temp__1 */;
...
static void cont__15_2(void) {
  ...
  // 72: for_each keys_of(self): (idx value)
  // 73:   if
  // 74:     parameter_count_of(body) == 2:
  // 75:       body idx value
  // 76:     :
