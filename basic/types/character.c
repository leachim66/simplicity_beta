...
EXPORT void phase_4__basic__types__character(void) {
  ...
  assign_value(&character__73, from_uchar32(73));
  ...
  assign_value(&character__85, from_uchar32(85));
  ...
  assign_value(&character__111, from_uchar32(111));
  ...
  assign_value(&character__105, from_uchar32(105));
  assign_value(&character__192, from_uchar32(192));
  assign_value(&character__32, from_uchar32(32));
  assign_value(&character__117, from_uchar32(117));
  ...
  assign_value(&number__0x20, from_uint32(32U));
  assign_value(&character__223, from_uchar32(223));
  assign_value(&character__79, from_uchar32(79));
