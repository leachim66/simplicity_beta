...
static CONTINUATION_INFO continuation_info[] = {
  ...
  {cont__4_2, &frame__4_1, 43, 43, 3, 37},
  ...
  {cont__8_2, &frame__8_1, 68, 74, 3, 30},
...
EXPORT void phase_4__basic__types__multi_dimensional_set(void) {
  ...
  define_method("types", "multi_dimensional_set", poly_idx__for_each, func__9_1);
}
...
EXPORT void phase_5__basic__types__multi_dimensional_set(void) {
  ...
  assign_variable(&var.types__multi_dimensional_set, &func__5_1);
  assign_variable(&var.std__multi_dimensional_set, &func__7_1);
