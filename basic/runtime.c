...
static void entry__std__runtime_major_version_1(void);
static NODE *func__std__runtime_major_version_1;
static NODE *get__std__runtime_major_version(void) {
  return var.std__runtime_major_version;
}
static void entry__std__runtime_minor_version_1(void);
static NODE *func__std__runtime_minor_version_1;
...
static MODULE_INFO module_info = {
  ...
  used_namespaces,
  {DEBUG_FILENAME("basic/runtime.sim")}
};
...
EXPORT void run__basic__runtime(void) {
  if (already_run) {
    func = frame->cont;
...
static void entry__std__runtime_major_version_1(void) {
  ...
  {
    NODE *result__node = (NODE *)(from_int(runtime_major_version()));
    arguments = node_p;
...
static void entry__std__runtime_minor_version_1(void) {
  ...
  {
    NODE *result__node = (NODE *)(from_int(runtime_minor_version()));
    arguments = node_p;
    arguments->slots[0] = result__node;
    argument_count = 1;
    func = frame->cont;
...
static void entry__std__runtime_patch_version_1(void) {
  ...
  {
    NODE *result__node = (NODE *)(from_int(runtime_revision()));
    arguments = node_p;
    arguments->slots[0] = result__node;
    argument_count = 1;
    func = frame->cont;
...
EXPORT void phase_1__basic__runtime(void) {
